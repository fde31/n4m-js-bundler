...
var logger = new Logger(); // We are using the EventEmitter class to showcase access to Node modules
...
var msg_int = function msg_int(number) {
  logger.log("Received int: ".concat(number));
};

var msg_float = function msg_float(number) {
  logger.log("Received float: ".concat(number));
};
...
var anything = function anything() {
  ...
  logger.log("Received anything: ".concat(args));
};
